...
export const HistorySidebar: React.FC<HistorySidebarProps> = ({
    ...
    return (
        <>
            ...
            {/* Sidebar - Desktop: pushes content, Mobile: overlay */}
            <motion.div
                initial={false}
                animate={{
                    x: isOpen ? 0 : '-100%',
                ...
                className="fixed left-0 top-0 h-full w-[260px] bg-white border-r border-gray-200 z-50 flex flex-col shadow-lg md:shadow-none"
            >
                {/* Header with Logo */}
                <div className="flex items-center gap-3 p-4 border-b border-gray-100">
                    ...
                    <button
                        onClick={onClose}
                        className="ml-auto p-1.5 hover:bg-gray-100 rounded-lg transition-colors md:hidden"
                    >
