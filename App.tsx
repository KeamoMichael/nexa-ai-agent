    ...
    <>
      ...
      <div className="flex h-screen bg-[#F9F9F9] dark:bg-gray-900 text-gray-900 dark:text-gray-100 font-sans overflow-hidden">
        ...
        >
          ...
          <div className="absolute bottom-0 left-0 right-0 px-4 pb-[env(safe-area-inset-bottom,0.5rem)] bg-gradient-to-t from-[#F9F9F9] via-[#F9F9F9] to-transparent dark:from-gray-900 dark:via-gray-900 dark:to-transparent pt-6 z-40">
